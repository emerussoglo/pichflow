...
export default function RapportsPage() {
      ...
      printContainer.innerHTML = `
        ...
        <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 12px; margin-bottom: 40px;">
          ...
          <div style="background: #f8fafc; padding: 15px; border-radius: 8px; border-left: 4px solid #2563EB;">
            <span style="color: #64748b; font-size: 11px; font-weight: bold; text-transform: uppercase;">Total Docs</span>
            <span style="display: block; color: #0f172a; font-size: 18px; font-weight: bold; margin-top: 5px;">
              ${totalDocs}
            </span>
          </div>
        ...
        <div style="margin-bottom: 40px;">
          <h3 style="color: #1e3a8a; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">Répartition des documents</h3>
          <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
            <thead>
              <tr style="background-color: #f1f5f9; text-align: left;">
                <th style="padding: 10px; border: 1px solid #cbd5e1;">Type de document</th>
                <th style="padding: 10px; border: 1px solid #cbd5e1; text-align: right;">Nombre</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style="padding: 10px; border: 1px solid #cbd5e1;">Factures</td>
                <td style="padding: 10px; border: 1px solid #cbd5e1; text-align: right; font-weight: bold; color: #2563EB;">${realData.facturesCount || 0}</td>
              </tr>
              <tr>
                <td style="padding: 10px; border: 1px solid #cbd5e1;">Devis</td>
                <td style="padding: 10px; border: 1px solid #cbd5e1; text-align: right; font-weight: bold; color: #10d409;">${realData.devisCount || 0}</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  const dataPie = [
    { name: 'Factures', value: realData?.facturesCount || 0, color: '#2563EB' },
    { name: 'Devis', value: realData?.devisCount || 0, color: '#10d409' },
  ];
  ...
  const totalDocs = (realData?.facturesCount || 0) + (realData?.devisCount || 0);
  ...
  return (
    <div className="reports-container" style={{ padding: '20px' }}>
      ...
      <div className="reports-header-actions no-print" style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '25px', alignItems: 'center' }}>
      ...
      <div className="charts-main-grid">
        ...
        <div className="chart-card donut-chart-section">
          <h4 style={{ marginBottom: '20px' }}>Répartition des documents</h4>
